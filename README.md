...
## 📌 About Me
- JAVA 교양 강의를 통해 프로그래밍에 입문하여 현재까지 프로젝트에서 줄곧 **백엔드**를 담당해왔습니다.<br>
- SSAFY 1학기, 관통 프로젝트 이후 로컬 서버에서만 작동하는 프로그램에 아쉬움을 느꼈습니다.<br>'왜 우리 프로그램은 노트북을 종료하면 함께 종료되는 걸까?'라는 의문을 가진 채 2학기를 마주했습니다. <br>
- 2학기에 접어들어 인프라의 존재를 알게 되었고, 의문에 답을 얻게 되었습니다. <br>
- 2학기의 첫 프로젝트에서 인프라를 담당한 팀원을 괴롭히며 관련 지식을 습득했고,<br>두 번째 프로젝트에서 **인프라와 백엔드를 담당**하여 **CI/CD 환경을 성공적으로 구축**했습니다. <br>
