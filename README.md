...
&emsp;&ensp;어떤 현상의 원인과 맥락을 파악하는 과정을 즐깁니다.✨
&emsp;&ensp;‘이 코드는 어떻게 동작하는 걸까?’, ‘왜 이렇게 작성했을까?’와 같은 질문을 자주 던지며,
&emsp;&ensp;이러한 끊임없는 탐구가 문제의 본질에 다가가는 열쇠라고 믿습니다.

## 📌 About Me
- JAVA 교양 강의를 통해 프로그래밍에 입문하여 현재까지 프로젝트에서 줄곧 백엔드를 담당해왔습니다. 
...
- 2학기의 첫 프로젝트에서 인프라를 담당한 팀원을 괴롭히며 관련 지식을 습득했고,<br>두 번째 프로젝트에서 인프라와 백엔드를 담당하여 CI/CD 환경을 성공적으로 구축했습니다. 
